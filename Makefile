...
delete-all:  ## Removes data from neo4j container
	@./delete_all.sh

restart-neo4j:  ## Restart neo4j container
	@./restart_neo4j.sh

full-rebuild: delete-all restart-neo4j load-examples startup-instructions  ## Perform a full rebuild of the examples

startup-instructions:    ## Instructions for accessing the neo4j GUI
	@echo "Now go to http://localhost:7474/browser/ and input queries eg: MATCH (n)-[r]->(m) RETURN n, r, m"
